...
/***/ function(module, exports, __webpack_require__) {
	...
	var CaptureTable = __webpack_require__(35);

	ReactDOM.render(React.createElement(CaptureTable, { url: '/api/captures', pollInterval: 2000 }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SearchForm = __webpack_require__(36);
	var QueueStatusBox = __webpack_require__(37);
	var CaptureList = __webpack_require__(39);
	var $ = __webpack_require__(38);

	var CaptureTable = React.createClass({
	  displayName: 'CaptureTable',

	  loadCapturesFromServer: function loadCapturesFromServer() {
	    $.ajax({
	      url: this.props.url,
	      dataType: 'json',
	      cache: false,
	  ...
	  handleSearchSubmit: function handleSearchSubmit(url) {
	    console.log(url);
	    $.ajax({
	      url: this.props.url,
	      dataType: 'json',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(QueueStatusBox, { url: '/api/queue', pollInterval: 2000, data: this.state.data }),
	      React.createElement(
	        'ul',
	        null,
	        React.createElement(CaptureList, { data: this.state.data })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { className: 'searchForm form-inline', onSubmit: this.handleSubmit },
	      React.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QueueStatusBox = React.createClass({
	  ...
	  loadQueueLen: function loadQueueLen() {
	    $.ajax({
	      url: this.props.url,
	      dataType: 'json',
	      cache: false,
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'queueStatusBox' },
	      'Current queue length: ',
	      this.state.data['queueLength']
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Capture = __webpack_require__(40);

	var CaptureList = React.createClass({
	  displayName: 'CaptureList',

	  render: function render() {
	    var captureNodes = this.props.data.map(function (capture) {
	      return React.createElement(Capture, { id: capture.id, href: capture.href, createdAt: capture.createdAt, path: capture.path, originalImage: capture.originalImage });
	    });
	    return React.createElement(
	      'div',
	      { className: 'captureList' },
	      React.createElement(
	        'div',
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'a',
	          { href: captureLink },
	          React.createElement('img', { src: this.props.originalImage, width: '200px' })
	        )
	      )
	    );
	  }
